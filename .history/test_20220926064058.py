        ...
        if task_name in ['SST-2', 'Yelp']:
            ...
            def change_SNLI_verb(verb_,change_or_not):
                ...
                if verb_ == 'No':
                    ...
                    return 'Regardless'
            c0 = res[:, tokenizer.encode(change_SNLI_verb("Yes",0), add_special_tokens=False)[0]]
            c1 = res[:, tokenizer.encode(change_SNLI_verb("Maybe",0), add_special_tokens=False)[0]]
            c2 = res[:, tokenizer.encode(change_SNLI_verb("No",0), add_special_tokens=False)[0]]
