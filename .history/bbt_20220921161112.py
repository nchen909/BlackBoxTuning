...
# for CMA
parser.add_argument("--weight_decay", default=0.2, type=float, help='openes hyperparameter')
# for openes or PEPG
...
if alg.lower()=='cma':
    ...
    start_time = time.time()
    print('please select alg from CMA, openes, DFO_tr, Nelder-Mead, Powell, SLSQP, COBYLA, BFGS etc')
end_time = time.time()
