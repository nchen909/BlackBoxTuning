...
if alg.lower()=='cma':
    cma_opts = {
        'seed': seed,
        'popsize': popsize,# every popsize times api call 
    ...
    options['Nelder-Mead'] = {"seed": seed, "disp": True, "ftol": 1e-26}#, "maxfev": 100
    options['COBYLA'] ={"seed": seed, "disp": True, "tol": 1e-25}
    options['BFGS'] ={"seed": seed, "disp": True, "gtol": 1e-5}#, "maxiter": 80
    options['SLSQP'] ={"seed": seed, "disp": True, "ftol": 1e-26}#, "maxiter": 200
