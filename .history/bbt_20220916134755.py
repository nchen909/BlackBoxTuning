...
if alg.lower()=='cma':
    ...
    while not es.stop():
        ...
        if parallel:
            ...
            print("model_forward_api.eval(prompt_embedding=np.array(500*[0.1])):",model_forward_api.eval(np.array(500*[0.1])))
            print("model_forward_api.eval(prompt_embedding=np.array(500*[0.2])):",model_forward_api.eval(np.array(500*[0.2])))
