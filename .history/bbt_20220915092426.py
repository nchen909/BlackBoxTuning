...
if alg.lower()=='cma':
    ...
    options={}
    options['Powell'] = {"seed": seed, "disp": True, "maxfev": 1000, "ftol": 1e-26}#
    options['Nelder-Mead'] = {"seed": seed, "disp": True, "maxfev": 1000, "ftol": 1e-26}
    options['COBYLA'] ={"seed": seed, "disp": True, "tol": 1e-25}
    options['BFGS'] ={"seed": seed, "maxiter": 80, "disp": True, "gtol": 1e-5}
    options['SLSQP'] ={"seed": seed, "maxiter": 200, "disp": True, "ftol": 1e-26}
