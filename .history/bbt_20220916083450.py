...
if alg.lower()=='cma':
    ...
    #this func executes the same way the loop below, and calls lots time of 
    ...
    options={}
    options['Powell'] = {"seed": seed, "disp": True, "ftol": 1e-26, "maxfev":budget if parallel else budget // popsize}#, "maxfev": 100
