        ...
        if task_name in ['SST-2', 'Yelp']:
            ...
            def change_SNLI_verb(verb_):
                if verb_ == 'No':
                    ...
                    return 'Regardless'
                return "No" if verb_=="Unless"
            c0 = res[:, tokenizer.encode(change_SNLI_verb("Yes"), add_special_tokens=False)[0]]
            c1 = res[:, tokenizer.encode(change_SNLI_verb("Maybe"), add_special_tokens=False)[0]]
            c2 = res[:, tokenizer.encode(change_SNLI_verb("No"), add_special_tokens=False)[0]]
