...
parser.add_argument("--alg", default='CMA', type=str, help='select from cma, dfo_tr, nelder-mead, powell, cobyla etc')
...
if alg.lower()=='cma':
    ...
    while not es.stop():
        ...
        # es.disp()
elif alg.lower() in ['dfo']
else:
    print('please select alg from cma, dfo_tr, nelder-mead, powell, cobyla etc')
end_time = time.time()
