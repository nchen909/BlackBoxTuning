...
if alg.lower()=='cma':
    ...
    while not es.stop():
        ...
        if parallel:
            ...
            # print("len(solutions),solutions[0].size:",len(solutions),solutions[0].size)#20,50
            print("model_forward_api.eval(500*[0.1]):",model_forward_api.eval(500*[0.1]))
            print("model_forward_api.eval(500*[0.2])",model_forward_api.eval(500*[0.2]))
            print("model_forward_api.eval(500*[0.2])",model_forward_api.eval(500*[0.2],print("model_forward_api.eval(500*[0.2])",model_forward_api.eval(500*[0.2]))))
