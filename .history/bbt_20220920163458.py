...
parser.add_argument("--sigma_init", default=2, action='store_true', help='openes hyperparameter')
parser.add_argument("--learning_rate", default=0.2, action='store_true', help='openes hyperparameter)
...
if alg.lower()=='cma':
    ...
    solver = es.OpenES(intrinsic_dim,                  # number of model parameters
            sigma_init=sigma_ini,            # initial standard deviation
