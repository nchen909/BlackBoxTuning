...
parser.add_argument("--alg", default='CMA', type=str, choices=['CMA','openes','PEPG','DFO_tr','Nelder-Mead','Powell'], help='select alg from CMA, openes, DFO_tr, Nelder-Mead, Powell, SLSQP, COBYLA, BFGS etc')
