...
if alg.lower()=='cma':
    ...
    options={}
    options['Powell'] = {"disp": True, "maxfev": 100, "ftol": 1e-26}
    options['Nelder-Mead'] = {"disp": True, "maxfev": 100, "ftol": 1e-26}
    options['COBYLA'] ={"disp": True, "tol": 1e-25}
    options['BFGS'] ={"maxiter": 100, "disp": True, "gtol": 1e-5}
    options['SLSQP'] ={"maxiter": 100, "disp": True, "ftol": 1e-26}
