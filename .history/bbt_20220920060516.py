...
parser.add_argument("--alg", default='CMA', type=str, help='select alg from CMA, openes, DFO_tr, Nelder-Mead, Powell, SLSQP, COBYLA, BFGS etc')#, choices=['CMA','openes','DFO_tr','Nelder-Mead','Powell']
