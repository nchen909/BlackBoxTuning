...
parser.add_argument("--alg", default='CMA', type=str, choice=['CMA','openes','DFO_tr','Nelder-Mead','Powell'], help='select alg from CMA, openes, DFO_tr, Nelder-Mead, Powell, SLSQP, COBYLA, BFGS etc')
