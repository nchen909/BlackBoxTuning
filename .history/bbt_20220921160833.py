...
parser.add_argument("--alg", default='CMA', type=str, choices=['CMA','openes','DFO_tr','Nelder-Mead','Powell'], help='select alg from CMA, openes, DFO_tr, Nelder-Mead, Powell, SLSQP, COBYLA, BFGS etc')
...
if alg.lower()=='cma':
    ...
    #    sigma_max_change=0.2,         # clips adaptive sigma to 20%
        learning_rate=0.2,           # learning rate for standard deviation
        learning_rate_decay = 1, # annealing the learning rate
