    ...
    def __init__(self, pred=None, target=None, seq_len=None, tokenizer=None):
        ...
        def change_SNLI_verb(verb_):
            if verb_ == 'No':
                ...
                return 'Regardless'
        self.label_map = {
            tokenizer.encode(change_SNLI_verb('Yes'), add_special_tokens=False)[0]: 0,
            tokenizer.encode(change_SNLI_verb('Maybe', add_special_tokens=False)[0]: 1,
            tokenizer.encode(change_SNLI_verb('No'), add_special_tokens=False)[0]: 2,
        }
